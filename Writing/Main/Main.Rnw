\documentclass[12pt,examcopy]{../uathesis}
    ...
    \usepackage{tikz}
      ...
      % minimum width={width("Possible anomalies")+2pt}
      \tikzstyle{simple} = [minimum width=3cm, minimum height=1cm, outer sep=0pt, text centered, align=center]
      \tikzstyle{start}  = [minimum width=3cm, minimum height=1cm, rectangle, rounded corners, draw=black, text centered, align=center, fill=grey!5]
      ...
      \tikzstyle{procs}  = [minimum width=3cm, minimum height=1cm, rectangle, draw=black, text centered, align=center, fill=grey!20]
      \tikzstyle{decis}  = [minimum width=3cm, minimum height=1cm, diamond, draw=black, inner sep=0pt, text centered, align=center, fill=grey!20]
      \tikzstyle{merge}  = [minimum width=3cm, minimum height=1cm, regular polygon, regular polygon sides=3, shape border rotate=180, inner sep=-5pt, draw=black, text centered, align=center, fill=grey!20]
