...
<<kde1, echo=FALSE, fig.align='center', fig.cap="Estimated density of the LOF scores.", out.width="0.68\\linewidth">>=
...
<<kde2, echo=FALSE, fig.align='center', fig.cap="The threshold computed using the global maximum and the local minimum.", out.width="0.68\\linewidth">>=
