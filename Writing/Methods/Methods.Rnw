...
<<lof-example, echo=FALSE, fig.align='center', fig.cap="The LOF approach", out.width="0.8\\linewidth">>=
set.seed(3)
...
text(x = max(b[,1])+0.3, y = max(b[,2])+0.2, labels = "p", cex = 0.8, pos = 3, family = "sans")
@
