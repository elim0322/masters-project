...
<<intro2, message=FALSE, echo=FALSE, out.width="0.6\\linewidth", fig.align='center', fig.cap="An example of an ROC curve for arbitrary data">>=
library(pROC)
data(aSAH)
