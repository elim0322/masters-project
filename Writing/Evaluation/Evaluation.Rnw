...
<<lofResults, dependson="result", echo=FALSE, out.width="0.6\\linewidth", fig.show='hold', fig.align='center', fig.cap="TPR and FPR across intrusion frequencies from the training and test sets">>=
x = 1:6
